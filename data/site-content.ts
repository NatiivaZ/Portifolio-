...
export const aboutContent = {
  pt: {
    title: "SOBRE MIM",
    intro: [
      "Sou profissional de dados e automação com mais de 3 anos de experiência na ANTT, nas unidades SUDEG, GEAUT e CCOBI, com foco em dados, automação e desenvolvimento full-stack aplicados a processos regulatórios. O núcleo do meu trabalho é extrair dados de autos de infração (cubo multas e bases correlatas), cruzar informações e validar se o processo e o auto observaram o rito processual exigido para inscrição em cadastros como SERASA, Dívida Ativa e CADIN.",
      "Dentro da própria rotina de trabalho, identifiquei processos manuais e construí soluções para resolvê-los: uma plataforma full-stack (NestJS, Next.js) para automação em massa de inscrições, com fila assíncrona, webhooks e dashboard em tempo real, e um verificador automatizado de processos do SEI em C#/.NET com Selenium, eliminando a triagem manual de centenas de processos.",
      ...
      "Busco unir rigor analítico, automação e comunicação clara: processos mais previsíveis, dados confiáveis e entregas que facilitem auditoria e a tomada de decisão. Atualmente cursando Ciência de Dados, estou aberto a oportunidades em análise de dados, automação/RPA ou desenvolvimento de software.",
    ],
  ...
  en: {
    title: "ABOUT ME",
    intro: [
      "I'm a data and automation professional with over 3 years of experience at ANTT, in the SUDEG, GEAUT and CCOBI units, focusing on data, automation and full-stack development applied to regulatory processes.",
      "Within my own daily routine, I identified manual processes and built solutions for them: a full-stack platform (NestJS, Next.js) for bulk registration automation, with an async queue, webhooks and a real-time dashboard, and an automated SEI process checker in C#/.NET with Selenium, eliminating manual triage of hundreds of processes.",
      ...
      "I aim to combine analytical rigor, automation and clear communication for auditable processes and reliable data. Currently pursuing a Data Science degree, I'm open to opportunities in data analysis, automation/RPA or software development.",
    ],
  ...
  es: {
    title: "SOBRE MÍ",
    intro: [
      "Soy profesional de datos y automatización con más de 3 años de experiencia en ANTT, en las unidades SUDEG, GEAUT y CCOBI, con enfoque en datos, automatización y desarrollo full-stack aplicados a procesos regulatorios.",
      "Dentro de mi propia rutina de trabajo, identifiqué procesos manuales y construí soluciones: una plataforma full-stack (NestJS, Next.js) para automatización masiva de inscripciones, con cola asíncrona, webhooks y dashboard en tiempo real, y un verificador automatizado de procesos del SEI en C#/.NET con Selenium, eliminando el triaje manual de cientos de procesos.",
      ...
      "Busco unir rigor analítico, automatización y comunicación clara para procesos auditables y datos confiables. Actualmente cursando Ciencia de Datos, estoy abierto a oportunidades en análisis de datos, automatización/RPA o desarrollo de software.",
    ],
...
export const dailyActivities = {
  pt: [
    ...
    "Verificação automatizada de processos do SEI (C#/.NET, Selenium) para triagem em lote",
  ...
  en: [
    "Data extraction from infraction records from the multas cube and related databases (Active Debt, SIFAMA), with analysis and preparation for registration",
    "Procedural validation for registration in SERASA, Active Debt and CADIN",
    "Registration and post-registration monitoring via Serasa Experian and EXPERIAN BRAZIL B2B",
    "SIFAMA workflow: batches, pre-batches and API transmission to SERASA",
    "SQL modeling and analysis in cubes and databases",
    "Automations and platforms: bulk PEFIN API, database comparator, SERASA registration and CADIN flows",
    "Automated SEI process verification (C#/.NET, Selenium) for batch triage",
    "Office package (Excel, Word, PowerPoint) for spreadsheets, documentation and presentations",
    "Cross-team collaboration to reduce rework and standardize deliveries",
  ],
  es: [
    "Extracción de datos de autos de infracción desde el cubo multas y bases correlatas (Deuda Activa, SIFAMA), con análisis y preparación para inscripción",
    "Validación del rito procesal para inscripción en SERASA, Deuda Activa y CADIN",
    "Inscripción y seguimiento post-inscripción vía Serasa Experian y EXPERIAN BRAZIL B2B",
    "Flujo en SIFAMA: lotes, pre-lotes y transmisión de los autos a SERASA vía API",
    "Modelado y análisis con SQL en cubos y bases de datos",
    "Automatizaciones y plataformas: API PEFIN en masa, comparador de bases, inscripción SERASA y flujos CADIN",
    "Verificación automatizada de procesos del SEI (C#/.NET, Selenium) para triaje en lote",
    "Paquete Office (Excel, Word, PowerPoint) para hojas de cálculo, documentación y presentaciones",
    "Colaboración con otras áreas para reducir retrabajo y estandarizar entregas",
  ],
}
...
export const experiences = [
  ...
  },
  {
    ...
    type: { pt: "Tempo integral", en: "Full-time", es: "Tiempo completo" },
    description: {
      pt: "Desenvolvimento de automações e plataformas: API PEFIN em massa, verificador de processos do SEI, comparador SERASA × Dívida Ativa, inclusão/baixas CADIN e fluxos SIFAMA/SERASA. Integração entre sistemas internos e bases de dados.",
      en: "Automation and platform development: bulk PEFIN API, SEI process checker, SERASA × Active Debt comparator, CADIN inclusion/write-offs and SIFAMA/SERASA flows.",
      es: "Desarrollo de automatizaciones y plataformas: API PEFIN, verificador de procesos del SEI, comparador SERASA × Deuda Activa, inclusión/bajas CADIN y flujos SIFAMA/SERASA.",
    },
    achievements: {
      pt: ["10+ soluções desktop e web entregues", "Plataforma PEFIN com filas, webhooks e dashboard", "Verificador de processos do SEI em C#/.NET com testes automatizados", "Integração SIFAMA, SERASA, CADIN e PEFIN"],
      en: ["10+ desktop and web solutions delivered", "PEFIN platform with queues, webhooks and dashboard", "SEI process checker in C#/.NET with automated tests", "SIFAMA, SERASA, CADIN and PEFIN integration"],
      es: ["10+ soluciones desktop y web entregadas", "Plataforma PEFIN con colas, webhooks y dashboard", "Verificador de procesos del SEI en C#/.NET con pruebas automatizadas", "Integración SIFAMA, SERASA, CADIN y PEFIN"],
    },
    skills: {
      pt: ["Python", "TypeScript", "C#/.NET", "NestJS", "Selenium"],
      en: ["Python", "TypeScript", "C#/.NET", "NestJS", "Selenium"],
      es: ["Python", "TypeScript", "C#/.NET", "NestJS", "Selenium"],
    },
  },
  {
    title: {
